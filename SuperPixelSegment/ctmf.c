 ...
 *
 * Reference: S. Perreault and P. H茅bert, "Median Filtering in Constant Time",
 ...
 *
 * Contact:
 *  Laboratoire de vision et syst猫mes num茅riques
 *  Pavillon Adrien-Pouliot
 *  Universit茅 Laval
 *  Sainte-Foy, Qu茅bec, Canada
 *  G1K 7P4
 *
 ...
 *                      the source image, in bytes. (相邻行像素的距离，单通道为width)
